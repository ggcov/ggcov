...
test_ctors(void)
{
    ...
    subtest("const string c'tor with null");
    {
    ...
    subtest("non-const string c'tor");
    {
    ...
    subtest("non-const string c'tor with null");
    {
	estring e((char *)0);
    ...
    subtest("const string and length c'tor");
    {
    ...
    subtest("const string and length c'tor with null");
    {
    ...
    subtest("non-const string and length c'tor");
    {
...
test_assignment()
{
    subtest("assignment by const string");
    {
    ...
    subtest("re-assignment by const string");
    {
    ...
    subtest("assignment by non-const string");
    {
    ...
    subtest("re-assignment by non-const string");
    {
...
test_truncate()
{
    subtest("truncate of zero length");
    {
	estring e;
    ...
    subtest("truncate of nonzero length");
    {
    ...
    subtest("truncate_to of zero length to zero");
    {
	estring e;
    ...
    subtest("truncate_to of zero length to non-zero, expanding");
    {
    ...
    subtest("truncate_to of non-zero length to zero");
    {
    ...
    subtest("truncate_to of non-zero length to non-zero, truncating");
    {
    ...
    subtest("truncate_to of non-zero length to non-zero, expanding");
    {
...
test_chomp()
{
    ...
    subtest("chomp just a single newline");
    {
	static const char x[] = "\n";
	estring e(x);
    ...
    subtest("chomp multiple newlines");
    {
    ...
    subtest("chomp just multiple whitespace");
    {
    ...
    subtest("chomp multiple whitespace");
    {
...
test_trim_nuls()
{
    subtest("trim_nuls, empty string");
    {
	estring e;
    ...
    subtest("trim_nuls, non-empty string");
    {
