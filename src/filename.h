...
const char *file_make_absolute_to_file(const char *filename, const char *absfile);
const char *file_make_absolute_to_dir(const char *filename, const char *absdir);
const char *file_make_absolute(const char *filename);
