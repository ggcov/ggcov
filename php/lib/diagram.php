...
// 
// $Id: diagram.php,v 1.1 2005-06-13 07:34:39 gnb Exp $
//
	...
	<table border="0" cellpadding="5" cellspacing="0">
	  <tr>
	    ...
	    <td valign="top">
	      ...
	      <a href="<?php echo $purls[1]; ?>"><img src="pan-up.gif" alt="Pan Up" border="0"></a><br>
	      <a href="<?php echo $purls[3]; ?>"><img src="pan-left.gif" alt="Pan Left" border="0"></a><br>
	      <a href="<?php echo $purls[5]; ?>"><img src="pan-right.gif" alt="Pan Right" border="0"></a><br>
	      <a href="<?php echo $purls[7]; ?>"><img src="pan-down.gif" alt="Pan Down" border="0"></a><br>
	    </td>
	  </tr>
	</table>
<?php
